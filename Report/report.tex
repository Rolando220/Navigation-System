...
Similarly, Figures \ref{fig:err_comp_lat}, \ref{fig:err_comp_lon}, and \ref{fig:err_comp_alt} demonstrate the position error reduction. The ESKF effectively bounds the GNSS positional inaccuracies, providing an estimation error that is continuously smoothed and kept well within the raw sensor's uncertainty limits, further proving the success of the data fusion algorithm.
